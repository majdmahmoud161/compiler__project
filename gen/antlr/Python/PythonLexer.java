// Generated from C:/Projects/compiler__project/src/antlr/Python/PythonLexer.g4 by ANTLR 4.13.2
...
public class PythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"SUM", "SUB", "MULT", "DIVISION", "EQUALS", "ISEQUALS", "POW", "MOD", 
			"GREATER", "SMALLER", "OR", "AND", "NOT", "IS", "IN", "TRUEBOOL", "FALSEBOOL", 
			"FOR", "IF", "ELSE", "ELIF", "WHILE", "BREAK", "CONTINUE", "RETURN", 
			"RANGE", "DEF", "PRINT", "TYPE", "INPUT", "LEN", "APPEND", "DOT", "COLONE", 
			"COMMA", "OPENPRAC", "CLOSEPRAC", "OPENKPRA", "CLOSEKPRA", "OPENSQUER", 
			"CLOSESQUER", "CLASS", "SUPER", "NONE", "AT", "PRIVATE", "PROTECTED", 
			"INT", "DOUBLE", "ID", "STRING", "WHSPACE", "NEWLINE"
		};
	}
